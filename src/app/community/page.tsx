  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,#ffe4e6_0%,#fff1f4_38%,#f8fafc_100%)] pb-28">
      ...
      <div className="mx-auto w-full max-w-4xl space-y-3 px-4 py-4">
                ...
                className={`shrink-0 rounded-full border px-4 py-2 text-sm font-semibold transition-all ${
                  active
                    ...
                    : tab.value === 'free'
                      ...
                      : 'border-white/55 bg-white/72 text-[#4b5563] hover:border-[#d6e5dd]'
                }`}
              >
                {tab.label}
              </button>
        ...
        {!isHotdeals && showForm && (
          <div className="space-y-3 rounded-[28px] border border-white/55 bg-white/80 p-4 shadow-[0_16px_40px_rgba(15,23,42,0.10)] backdrop-blur-xl">
        ...
        {loading ? (
          ...
          <div className="rounded-[28px] border border-white/55 bg-white/80 px-6 py-10 text-center text-sm text-[#9ca3af] shadow-[0_14px_34px_rgba(15,23,42,0.08)] backdrop-blur-xl">

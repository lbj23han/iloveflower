...
export default function SpotDetailPanel({
  ...
  return (
    <div className="flex h-full min-h-0 flex-col overflow-y-auto">
      <div className="shrink-0 border-b border-white/35 px-5 pb-5 pt-5">
        {/* 헤더 */}
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className={`flex h-10 w-10 items-center justify-center rounded-full border text-base shadow-sm transition-colors ${
                isFavorite ? 'border-[#ff6b81]/40 bg-[#fff1f4] text-[#ff4d6d]' : 'border-white/55 bg-white/72 text-[#6b7280]'
              }`}
              aria-label={isFavorite ? '찜 해제' : '찜하기'}
            >♥</button>
            {onClose && (
              <button onClick={onClose} className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-white/70 text-sm text-[#6b7280] shadow-sm">
                ✕
              </button>
            )}
          </div>
        ...
        {/* 개화 현황 */}
        {bloomStatus && (
          <div className="mb-4 rounded-[24px] border border-white/55 bg-white/72 px-4 py-4">
        ...
        <div className="mb-4 grid gap-3 md:grid-cols-2">
          <div className="rounded-[24px] border border-white/55 bg-white/74 px-4 py-4">
        ...
        {(spot.phone || spot.website_url) && (
          <div className="mb-4 space-y-2 rounded-[24px] border border-white/55 bg-white/72 px-4 py-4">
        ...
        <div className="grid gap-2 sm:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]">
          ...
          <div className="flex items-center justify-center rounded-2xl border border-white/55 bg-white/72 px-4 py-3">

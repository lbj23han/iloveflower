...
import { FlowerSpotMapItem, CATEGORY_LABELS, FLOWER_TYPE_LABELS, ViewportBounds } from '@/types';
...
export default function KakaoMap({
  ...
  useEffect(() => {
    ...
    spots.forEach((spot) => {
      ...
      const label = flowerLabel ? FLOWER_TYPE_LABELS[flowerLabel] ?? categoryLabel : categoryLabel;
